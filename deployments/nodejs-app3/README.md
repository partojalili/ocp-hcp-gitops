...
```bash
oc get route nodejs-app3 -n nodejs-app
```
...
```bash
oc get deployment nodejs-app3 -n nodejs-app
oc get pods -l app=nodejs-app3 -n nodejs-app
oc logs -l app=nodejs-app3 -n nodejs-app
```
