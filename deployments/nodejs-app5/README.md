...
```bash
oc get route nodejs-app5 -n nodejs-app
```
...
```bash
oc get deployment nodejs-app5 -n nodejs-app
oc get pods -l app=nodejs-app5 -n nodejs-app
oc logs -l app=nodejs-app5 -n nodejs-app
```
