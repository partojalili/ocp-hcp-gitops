...
```bash
oc create -f pipeline/pipelinerun.yaml -n nodejs-app2
```

### View Pipeline Runs

```bash
oc get pipelinerun -n nodejs-app2
```

### View Application

```bash
oc get all -n nodejs-app2
```
...
```bash
oc get route nodejs-app2 -n nodejs-app2
```
...
```bash
oc get deployment nodejs-app2 -n nodejs-app2
oc get pods -l app=nodejs-app2 -n nodejs-app2
oc logs -l app=nodejs-app2 -n nodejs-app2
```
