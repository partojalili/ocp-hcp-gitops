...
```bash
oc get route nodejs-app-dev -n nodejs-app
```
...
```bash
oc get deployment nodejs-app-dev -n nodejs-app
oc get pods -l app=nodejs-app-dev -n nodejs-app
oc logs -l app=nodejs-app-dev -n nodejs-app
```
