...
> **Note:** This application is scaffolded into the **ocp-hcp-gitops** repository under `/apps/nodejs/`. It is automatically discovered by Red Hat Developer Hub and appears in the catalog within 5 minutes of merging the PR.

## Repository Structure

This application lives in: `ocp-hcp-gitops/apps/nodejs/`
