...
- **Region**: `us-east1`
- **Base Domain**: `wxgzn.gcp.redhatworkshops.io`
...
### Console URL
```
https://console-openshift-console.apps.gcp-cluster1.wxgzn.gcp.redhatworkshops.io
```

### API URL
```
https://api.gcp-cluster1.wxgzn.gcp.redhatworkshops.io:6443
```
