...
- **Region**: `us-east1`
- **Base Domain**: `xhsc9.gcp.redhatworkshops.io`
...
### Console URL
```
https://console-openshift-console.apps.gcp-cluster1.xhsc9.gcp.redhatworkshops.io
```

### API URL
```
https://api.gcp-cluster1.xhsc9.gcp.redhatworkshops.io:6443
```
