...
- **Region**: `us-east1`
- **Base Domain**: `zc2p9.gcp.redhatworkshops.io`
...
### Console URL
```
https://console-openshift-console.apps.gcp-cluster.zc2p9.gcp.redhatworkshops.io
```

### API URL
```
https://api.gcp-cluster.zc2p9.gcp.redhatworkshops.io:6443
```
