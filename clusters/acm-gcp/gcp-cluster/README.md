...
- **Region**: `us-east1`
- **Base Domain**: `apps.cluster-ptfhc.dyn.redhatworkshops.io`
...
### Console URL
```
https://console-openshift-console.apps.gcp-cluster.apps.cluster-ptfhc.dyn.redhatworkshops.io
```

### API URL
```
https://api.gcp-cluster.apps.cluster-ptfhc.dyn.redhatworkshops.io:6443
```
