...
- **Region**: `us-east1`
- **Base Domain**: `qnwsf.gcp.redhatworkshops.io`
...
### Console URL
```
https://console-openshift-console.apps.gcp-cluster.qnwsf.gcp.redhatworkshops.io
```

### API URL
```
https://api.gcp-cluster.qnwsf.gcp.redhatworkshops.io:6443
```
