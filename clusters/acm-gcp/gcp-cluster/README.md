...
- **Region**: `us-east1`
- **Base Domain**: `tgdft.gcp.redhatworkshops.io`
...
### Console URL
```
https://console-openshift-console.apps.gcp-cluster.tgdft.gcp.redhatworkshops.io
```

### API URL
```
https://api.gcp-cluster.tgdft.gcp.redhatworkshops.io:6443
```
