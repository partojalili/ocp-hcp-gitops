...
- **Region**: `us-east1`
- **Base Domain**: `86nk6.gcp.redhatworkshops.io`
...
### Console URL
```
https://console-openshift-console.apps.gcp-cluster.86nk6.gcp.redhatworkshops.io
```

### API URL
```
https://api.gcp-cluster.86nk6.gcp.redhatworkshops.io:6443
```
